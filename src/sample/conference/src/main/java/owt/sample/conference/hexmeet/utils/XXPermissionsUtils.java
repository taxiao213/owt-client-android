...
public class XXPermissionsUtils {
    ...
    /*获取指纹信息权限*/
    private String[] fingerprintPermission = new String[]{Manifest.permission.USE_FINGERPRINT};
    /*拨打电话权限*/
    ...
    public void hasCameraPermission(Function<Boolean> booleanFunction, Context context) {
        ...
        if (XXPermissions.isHasPermission(context, cameraPermission, recordPermission, readOrWritePermission)) {
            booleanFunction.action(true);
        } else {
            requestPermission(booleanFunction, cameraPermission, recordPermission, readOrWritePermission);
        }
    }
